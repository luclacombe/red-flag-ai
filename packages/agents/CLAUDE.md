...
- **max_tokens estimation**: `Math.min(clauseCount * 800 + 4096, 64000)` — ~800 tokens per clause (non-English is more token-dense) + 4K buffer. Cap at 64K (Sonnet 4.6 max output).
